...
export default async function NewPostPage({ searchParams }: { searchParams: Promise<{ date?: string }> }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <PostForm brand={brand} assets={assets} categories={categories} defaultDate={defaultDate} />
    </div>
  );
}
